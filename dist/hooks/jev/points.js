...
export function getJudgmentPoint(name) {
    const point = JUDGMENT_POINTS[name];
    if (!point)
        throw new Error('[jev] unknown judgment point: ' + name);
    return point;
}
/**
 ...
 */
export function recordJudgment(pointName, call) {
