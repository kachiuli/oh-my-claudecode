...
function fixtureTmuxServerIdentity() {
...
describe('recovery terminal publication revision fence', () => {
    it('publishes no final when a competing normal config writer wins after the recovery snapshot', async () => {
        ...
        const finalized = await finalizeRecoveryOwnerResult({ teamName, cwd, workerName: 'worker-1', requestId: 'request-a', instanceId: TEAM_INSTANCE_ID }, 'recovery-a', result, {
