...
- Routing: at the start of every lead session and before workflow init or review, read `.omc/routing.md` if present. Treat its role, model, effort and executable choices as overridable defaults; verify availability, record the actual choice and reason for any fallback in workflow evidence, and keep OMC review gates explicit.
